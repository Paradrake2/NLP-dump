...
def generate_sentence(bigram_probs, max_words=20):
    ...
    # Get all possible starting words (words that appear as first in bigrams)
...
def main():
    if len(sys.argv) < 3:
        print("Usage: python HW2_490_4 corpus.txt test_corpus.txt bigram_model.json")
        return
    ...
    try:
        ...
        # Generate a sentence
        print("\nGenerated Sentence:")
        print(generate_sentence(loaded_bigram_probs))
